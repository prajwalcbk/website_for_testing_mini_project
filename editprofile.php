...
<body>
    ...
    <div class="login">    
        ...
        <input type="text" name="Lname" id="Uname" placeholder="Last name" value="<?php echo $check['lname'];?>">    
        <br><br>   

        <label>  Email    </label>     <input type="email" name="email" id="Pass" placeholder="email@gmail.com"  value="<?php echo $check['email'];?>">    
        ...
        <input type="number" name="number" id="Pass" placeholder="9876543210" value="<?php echo $check['number'];?>">    
        <br><br>    

        <label>Deliver Address    
            
        </label>       
        <input type="text" name="address" id="Pass" value="<?php echo $check['address'];?>">    
        <br><br>    

        <label>Pincode   
            
        </label>       
        <input type="number" name="pincode" id="Pass" placeholder="562102" value="<?php echo $check['pincode'];?>">    
        <br><br>    
            </table> 
