    ...
    <section>
        ...
        <div class="section2">
            ...
            else
            {
                ...
                if(($p==1) || ($p==2) || ($p==3))
                {
                    $sql="select * from product where category='$p'";
                    $result=$conn->query($sql);
                    if($p==1)
                        echo "<br><br><br><br><hr><br><h1 align='center'>Mobiles</h1><br><hr>";
                    if($p==2)
                        echo "<br><br><br><br><hr><br><h1 align='center'>Cameras</h1><br><hr>";
                    if($p==3)
                        echo "<br><br><br><br><hr><br><h1 align='center'>Laptops</h1><br><hr>";
